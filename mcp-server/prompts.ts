  ...
  if (name === "screensync_operator") {
    ...
    return userMsg(
      [
        ...
        "3. DECIDE: Select the fastest zero-fail path (intent URL > in-page typing; hierarchy-driven text tap > coordinate guess; web_request_help for CAPTCHA/2FA; web_request_access when a site says access not granted - never send the user to the dashboard).",
