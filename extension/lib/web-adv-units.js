// ScreenSync page-side units (self-contained `func` payloads for
// chrome.scripting.executeScript) + ensureHooks.
import { main } from './web-adv-core.js';
export { main, isolated } from './web-adv-core.js';
export function ssInstallHooks() {
...
export function ssReadBuffer(args) {
...
export function ssWaitFor(args) {
